...
function Testimonials() {
  const testimonials = [
    ...
    {
      name: "",
      text: `What sets Claudia apart is her unwavering dedication to personal growth. She’s always learning and her open-mindedness makes me feel truly supported every step of the way. I genuinely believe she’s as invested in my healing as I am.`,
      image: "",
    },
    {
      name: "RB",
